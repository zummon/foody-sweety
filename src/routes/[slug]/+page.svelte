...
<div class="bg-gray-900 max-w-screen-md rounded-xl mx-auto my-8 shadow-2xl">
	<p>
		<a
			href="/"
	...
	<div class="prose prose-invert prose-img:rounded-xl prose-img:mx-auto prose-img:object-contain prose-img:max-h-96 prose-img:max-w-full max-w-none px-4 sm:px-8 mb-8 text-center">
		<h1>{title}</h1>
		<p>
