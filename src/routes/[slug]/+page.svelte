...
<div class="dark:bg-gray-900 bg-gray-50 max-w-screen-md rounded-xl mx-auto my-8 shadow-2xl">
	<p>
		<a
			href="/"
			class="transition duration-500 hover:text-pink-500 px-6 py-4 rounded-tl-xl inline-block font-bold"
		>
			<!-- reply -->
	...
	<p class="flex items-center justify-end">
		<a
			href="/"
			class="transition duration-500 hover:text-pink-500 px-6 py-4 rounded-br-xl font-bold"
		>
			<!-- share  -->
